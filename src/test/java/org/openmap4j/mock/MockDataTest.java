...
public class MockDataTest extends AbstractTest {

	@Test
	public void testRange() {
		assertEquals(MockData.range(1, 10,1).count(),10);
 	}

	@Test
	public void testRangePoint() {
		assertEquals( MockData.rangePoint(1, 10, 2,1).count(),10);
 	}
