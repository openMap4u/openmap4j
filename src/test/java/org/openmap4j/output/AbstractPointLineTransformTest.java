...
public abstract class AbstractPointLineTransformTest extends AbstractPointTransformTest  {

	@Override
	Symbolizeable[] getSymbol() {
		return new Symbolizeable[] { StyleBuilderFactory.getLineSymbolBuilder()
