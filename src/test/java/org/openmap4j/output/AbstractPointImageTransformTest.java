...
public abstract class AbstractPointImageTransformTest extends AbstractPointTransformTest  {

	@Override
	Symbolizeable[] getSymbol() {
		return new Symbolizeable[] { StyleBuilderFactory.getImageSymbolBuilder().imagePath(FileSystems.getDefault().getPath("src","test","resources","image","image.png")).build()};
	}
