...
public abstract class AbstractPointTextTransformTest extends AbstractPointTransformTest  {

	@Override
	Symbolizeable[] getSymbol() {
		return new Symbolizeable[] {StyleBuilderFactory.getTextSymbolBuilder().text("Hello").fontSize(20).fill(Color.BLACK).x(0).y(0)
				.build()};
	}
