...
import org.openmap4j.output.AbstractPointTextTransformTest;
import org.openmap4j.output.Canvas;
import org.openmap4j.plugin.output.svg.SvgCanvasPlugin;

public class SvgTextSymbolTransformTest extends AbstractPointTextTransformTest {
	...
	protected Writer getWriter() throws IOException {
	 			return super.getFile("target","SvgTextSymbolTransformTest.svg");
	}
