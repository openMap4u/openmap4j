...
import org.openmap4j.builder.geom.LineBuilder;

public class LineBuilderTest extends AbstractTest {
	
	LineBuilder<Shape> lB = null;
	
	@BeforeEach
	public void before() {
		lB= new LineBuilder<Shape>();
	}
